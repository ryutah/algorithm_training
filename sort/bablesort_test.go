...
func TestBablesort(t *testing.T) {
...
func TestBableSortEmptyList(t *testing.T) {
	arr := []int{}
	got := BableSort(arr)
	want := []int{}
	if !reflect.DeepEqual(want, got) {
...
func TestBableSortSortedList(t *testing.T) {
...
func TestBablSortSameValueList(t *testing.T) {
